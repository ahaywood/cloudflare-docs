...
Use the [origin TLS client auth hostnames certificates endpoint](/api/resources/origin_tls_client_auth/subresources/hostnames/subresources/certificates/methods/create/) to upload your custom certificate.
