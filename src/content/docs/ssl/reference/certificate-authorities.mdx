...
Sectigo certificates offer broad browser compatibility. For the most up-to-date compatibility information, refer to the [Sectigo knowledge base](https://www.sectigo.com/knowledge-base).
